...
Просто запустите приложение. При запуске появится пользовательский интерфейс, где вы сможете ввести свой **API ключ** и **URL** для эндпоинта. Приложение запомнит эти настройки для будущих сессий.
