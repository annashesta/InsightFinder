...
*   **{outlier_summary}**
*   **{outlier_details}**
*   Сообщите о наличии выбросов, если они обнаружены. Укажите, в какой группе и на каких признаках они сконцентрированы, и как это может повлиять на анализ. **Графики для этого раздела (если генерировались) также должны быть проверены и вставлены только при наличии подтверждения.**
